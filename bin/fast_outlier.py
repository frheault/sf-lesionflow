#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""FSL FAST white matter outlier lesion segmentation.

Segments white matter hyperintensities on FLAIR images by calculating
intensity z-scores against healthy deep white matter regions.
"""
...
def main():
    ...
    # Identify healthy white matter voxels using partial volume estimates.
    ...
    # Compute intensity threshold from healthy white matter distribution.
    ...
    # Generate binary lesion mask within deep white matter region.
